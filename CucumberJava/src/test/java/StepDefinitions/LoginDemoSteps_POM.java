...
public class LoginDemoSteps_POM {
	...
	public void application_browser_is_open() {

		
	System.out.println(" *****************   WE ARE INSIDE => LoginDemoSteps_POM **************");	
	...
	public void application_user_is_on_login_page() {
	...
	@When("^application user enters (.*) and (.*)$")
	public void application_user_enters_username_and_password(String username, String password) {
	...
	public void application_user_clicks_on_login() {
	...
	public void application_user_is_navigated_to_home_page() {
		
		System.out.println("Inside Step - USer is navigated to Home Page");
	
		//driver.getPageSource().contains("Sign out");
		//driver.findElement(By.xpath("//p[contains(text(), 'Welcome to your account')]")).isDisplayed();
		
		login.validateSignOutIsDispalyed();
